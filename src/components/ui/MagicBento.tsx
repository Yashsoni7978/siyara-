...
export interface BentoProps {
  ...
  enableTilt?: boolean;
  glowColor?: string; // RGB string, e.g. "90, 166, 138" for accent green
  clickEffect?: boolean;
...
const DEFAULT_GLOW_COLOR = '90, 166, 138'; // Siyaraa Accent Green
...
const ParticleCard: React.FC<{
  ...
  return (
    <Link href={href} ref={cardRef} className={className}>
      {children}
    </Link>
  );
};
