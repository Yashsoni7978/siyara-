...
export const SERVICES = [
  { id: 'web-development',       num: '01', icon: '🌐', name: 'Web Development',           fix: 'weak online presence',          category: 'chosen',    waLink: 'webDev', desc: 'Not just a website — a high-performance digital storefront built to convert. Fast, beautiful, mobile-perfect, and engineered to rank.', ctaText: 'Get Chosen' },
  { id: 'app-development',       num: '02', icon: '📱', name: 'App Development',            fix: 'no mobile product',             category: 'chosen',    waLink: 'appDev', desc: 'Your customers live on their phones. Your business should too. We build mobile apps that are intuitive, fast, and built around what your users actually need.', ctaText: 'Get Chosen' },
  { id: 'ui-ux-design',          num: '03', icon: '✦',  name: 'UI / UX Design',             fix: 'poor user experience',          category: 'chosen',    waLink: 'uiux', desc: 'Design that makes people stay, trust, and act. Every screen, every interaction — crafted to reduce friction and guide your user toward exactly what you want them to do next.', ctaText: 'Get Efficient' },
  { id: 'ai-automation',         num: '04', icon: '⚡', name: 'AI Automation',              fix: 'slow manual operations',        category: 'efficient', waLink: 'aiAuto', desc: 'Stop doing manually what a system can do instantly. We identify the repetitive processes in your business and automate them.', ctaText: 'Get Efficient' },
  { id: 'ai-agents',             num: '05', icon: '🤖', name: 'AI Agent Development',       fix: 'missed leads & response delays',category: 'efficient', waLink: 'aiAgent', desc: 'Custom AI agents that handle your leads, answer questions, qualify prospects, and follow up — 24/7. Never miss a lead again.', ctaText: 'Get Chosen' },
  { id: 'branding',              num: '06', icon: '◈',  name: 'Branding & Identity',        fix: 'forgettable brand',             category: 'chosen',    waLink: 'branding', desc: 'Your brand is the first thing a client judges — before they read a single word. Logo, visual identity, brand language — everything that makes you the premium option in the room.', ctaText: 'Get Revenue' },
  { id: 'social-media',          num: '07', icon: '◉',  name: 'Social Media Management',    fix: 'inconsistent online presence',  category: 'revenue',   waLink: 'social', desc: 'Showing up consistently with content that actually builds your audience — not just fills a grid. Strategy, design, writing, posting, and engagement. Every day.', ctaText: 'Get Revenue' },
  { id: 'performance-marketing', num: '08', icon: '📈', name: 'Ads & Performance Marketing',fix: 'wasted ad spend',               category: 'revenue',   waLink: 'ads', desc: 'Meta, Google, YouTube — campaigns where every rupee has a job to do. We build, test, and scale ad systems tied directly to your revenue goals. No vanity metrics.', ctaText: 'Get Found' },
  { id: 'seo',                   num: '09', icon: '🔍', name: 'SEO Optimisation',           fix: 'invisible on Google',           category: 'found',     waLink: 'seo', desc: 'Rank at the top — and stay there. We build SEO strategies that are technical, content-driven, and long-game.', ctaText: 'Get Found' },
  { id: 'geo',                   num: '10', icon: '🧠', name: 'GEO Optimisation',           fix: 'invisible in AI search',        category: 'found',     waLink: 'geo', desc: 'When someone asks ChatGPT, Perplexity, or Google AI for recommendations — is your business mentioned? GEO is the new frontier of search.', ctaText: 'Get Found' },
  { id: 'google-business',       num: '11', icon: '📍', name: 'Google Business Profile',    fix: 'not showing on Maps',           category: 'found',     waLink: 'gbp', desc: 'When someone searches your category in Jaipur, your profile should be the first thing they see — fully optimised, fully trusted.', ctaText: 'Get Revenue' },
  { id: 'content-creation',      num: '12', icon: '✍',  name: 'Content Creation',           fix: 'no content strategy',           category: 'revenue',   waLink: 'content', desc: 'Content that looks premium, reads sharp, and actually builds your authority — not filler posts to hit a quota.', ctaText: 'Get Revenue' },
] as const

export const INDUSTRIES = [
  { id: 'restaurants', icon: '🍽️', name: 'Restaurants & Food',         waLink: 'restaurant', desc: 'Diners eat with their eyes first. We build digital presences that drive footfall, table reservations, and food orders. Stop relying on aggregators and own your audience.', ctaText: 'Pack Your Tables' },
  { id: 'fashion',     icon: '👗', name: 'Fashion & Clothing',          waLink: 'fashion',    desc: 'In fashion, aesthetic is everything. We design high-converting e-commerce experiences and visual campaigns that turn casual browsers into loyal brand advocates.', ctaText: 'Elevate Your Brand'    },
  { id: 'realestate',  icon: '🏠', name: 'Real Estate & Interiors',     waLink: 'realestate', desc: 'High-ticket sales require immense trust. We craft premium digital showcases that highlight your properties and portfolio, generating highly qualified leads.', ctaText: 'Get Premium Leads' },
  { id: 'ecommerce',   icon: '🛍️', name: 'E-commerce & D2C',           waLink: 'ecommerce',  desc: "Your store isn't just a catalogue—it's a sales engine. We optimise every touchpoint for conversion, retention, and maximum return on ad spend.", ctaText: 'Scale Your Store'  },
  { id: 'events',      icon: '💍', name: 'Events & Weddings',           waLink: 'events',     desc: 'You create unforgettable moments; we make sure people know about them. We build authority and visual proof that makes you the obvious choice for high-end clients.', ctaText: 'Book More Events'     },
] as const
