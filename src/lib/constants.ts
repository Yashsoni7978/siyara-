...
export const SERVICES = [
  ...
  { id: 'whatsapp-marketing',    num: '13', icon: 'social', name: 'WhatsApp Marketing',         fix: 'low open rates',                category: 'revenue',   waLink: 'default', desc: 'Direct-to-customer campaigns with 98% open rates. We build automated flows that turn inquiries into actual revenue.', ctaText: 'Get Revenue' },
  { id: 'email-marketing',       num: '14', icon: 'pen',    name: 'Email Marketing',            fix: 'dead email lists',              category: 'revenue',   waLink: 'default', desc: 'Beautiful, high-converting email sequences that nurture your audience and drive consistent backend sales.', ctaText: 'Get Revenue' },
] as const
